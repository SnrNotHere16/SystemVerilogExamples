...
HD_PWD='C:/Users/OAkun/Documents/GitHub/SystemVerilogExamples/Code/SequenceDetectorMealy/SequenceDetectorMealy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SequenceDetectorTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SequenceDetectorTop.tcl
