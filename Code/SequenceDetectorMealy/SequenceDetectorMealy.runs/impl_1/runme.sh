...
HD_PWD='C:/Users/OAkun/Documents/GitHub/SystemVerilogExamples/Code/SequenceDetectorMealy/SequenceDetectorMealy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SequenceDetectorTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SequenceDetectorTop.tcl -notrace
