...
EAStep vivado -log UniversalShiftRegisterTopModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UniversalShiftRegisterTopModule.tcl -notrace
